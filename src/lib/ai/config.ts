...
interface AiConfigRow {
  ...
  product_suggestions_enabled: boolean
}

const CONFIG_COLUMNS =
  'provider, model, api_key, system_prompt, is_active, auto_reply_enabled, auto_reply_max_per_conversation, handoff_agent_id, embeddings_api_key, product_suggestions_enabled'
...
export async function loadAiConfig(
  ...
  return {
    ...
    embeddingsApiKey,
    productSuggestionsEnabled: row.product_suggestions_enabled,
  }
}
